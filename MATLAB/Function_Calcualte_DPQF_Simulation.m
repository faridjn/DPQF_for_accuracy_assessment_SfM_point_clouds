function Function_Calcualte_DPQF_Simulation(MAIN_FOLDER)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
fileCameraXML = [MAIN_FOLDER 'trajectory.xml']; % camera IO and EO
...
% GET PARAMS
camIO = GetCamIO_v2(cameraXML);  % get Interior Orinetation Parameters
